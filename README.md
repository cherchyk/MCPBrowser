...
```bash
code --install-extension mcpbrowser-0.2.11.vsix
```
...
Published on npm as [mcpbrowser](https://www.npmjs.com/package/mcpbrowser) v0.2.11.
...
Available in the [MCP Registry](https://registry.modelcontextprotocol.io/) as `io.github.cherchyk/browser` v0.2.11.
