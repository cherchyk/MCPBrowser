...
**From GitHub Release:**
Download from [GitHub Releases](https://github.com/cherchyk/MCPBrowser/releases/tag/extension-v0.1.0):
```bash
...
📦 [View on Marketplace](https://marketplace.visualstudio.com/items?itemName=cherchyk.mcpbrowser-config)
